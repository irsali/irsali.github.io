import"./Bzak7iHL.js";import"./BrF70vDP.js";import{i as x,k as n,l as _,j as R,m as s,o as a,n as V}from"./v0O3ks5t.js";import{h as t}from"./IeDmrjg6.js";const A={title:"Aurelia Bootstrap Startup",date:"2017-10-06",description:"aurelia",categories:["others"],tags:["Aurelia"],icon:"icon-aurelia",readingTime:"3 min read"},{title:q,date:E,description:F,categories:S,tags:T,icon:I,readingTime:Y}=A;var G=x(`<h1>Getting Started</h1> <h2>Pre Requisites</h2> <p>Aurelia Setup project</p> <h3>Installs</h3> <pre class="language-bash"><!></pre> <h3>Update aurelia.json for path of above installs</h3> <pre class="language-json"><!></pre> <h3>Register bootstrap plugin with Aurelia</h3> <p>Aurelia-bootstrap supports both Bootstrap 3 and 4. to use the version 4.
...
<span class="token function">npm</span> <span class="token function">install</span> tether <span class="token parameter variable">--save</span></code>`),a(p);var o=n(p,4),g=s(o);t(g,()=>`<code class="language-json"><span class="token punctuation">[</span>
	...
	<span class="token punctuation">&#125;</span>
<span class="token punctuation">]</span></code>`),a(o);var e=n(o,6),f=s(e);t(f,()=>`<code class="language-ts"><span class="token keyword">export</span> <span class="token keyword">function</span> <span class="token function">configure</span><span class="token punctuation">(</span>aurelia<span class="token operator">:</span> Aurelia<span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>`),a(e);var c=n(e,8),v=s(c);t(v,()=>`<code class="language-ts"><span class="token function">constructor</span><span class="token punctuation">(</span><span class="token keyword">private</span> controller<span class="token operator">:</span> ValidationController<span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>`),a(u);var l=n(u,2),y=s(l);t(y,()=>`<code class="language-ts"><span class="token keyword">function</span> <span class="token function">save</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>`),a(l);var i=n(l,2),w=s(i);t(w,()=>'<code class="language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>input</span> <span class="token attr-name">type</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>”text”<span class="token punctuation">"</span></span> <span class="token attr-name">value.bind</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>formField.value &amp; validate<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span></code>'),a(i);var r=n(i,4),b=s(r);t(b,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token punctuation">&#123;</span> ValidationRenderer<span class="token punctuation">,</span> RenderInstruction<span class="token punctuation">,</span> ValidateResult <span class="token punctuation">&#125;</span> <span class="token keyword">from</span> <span class="token string">'aurelia-validation'</span><span class="token punctuation">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">class</span> <span class="token class-name">BootstrapFormValidationRenderer</span> <span class="token punctuation">&#123;</span>
	...
	<span class="token function">remove</span><span class="token punctuation">(</span>element<span class="token operator">:</span> Element<span class="token punctuation">,</span> result<span class="token operator">:</span> ValidateResult<span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
		...
		<span class="token punctuation">&#125;</span>
	<span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`),a(r),V(2),R(d,k)}export{U as default,A as metadata};
