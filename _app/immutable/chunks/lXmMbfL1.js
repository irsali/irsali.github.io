import"./Bzak7iHL.js";import"./BrF70vDP.js";import{i as o,k as p,l as c,j as l,m as r,o as u,n as i}from"./v0O3ks5t.js";import{h as k}from"./IeDmrjg6.js";const a={title:"Aurelia Breeze Server Startup",date:"2017-10-06",description:"aurelia, breeze",categories:["others"],tags:["Aurelia"],icon:"icon-aurelia",readingTime:"1 min read"},{title:y,date:_,description:f,categories:z,tags:x,icon:w,readingTime:C}=a;var d=o('<h1>Getting Started</h1> <h2>Pre Requisites</h2> <p>Web API 2.x Project</p> <h2>Install packages</h2> <ol><li><p>Breeze.Server.ContextProvider.EF6</p></li> <li><p>Breeze.Server.WebApi2</p></li></ol> <h2>Breeze controller example</h2> <pre class="language-cs"><!></pre> <h1>References</h1> <ol><li><a href="http://breeze.github.io/doc-net/nuget-packages.html" rel="nofollow">http://breeze.github.io/doc-net/nuget-packages.html</a></li></ol>',1);function m(t){var n=d(),s=p(c(n),12),e=r(s);k(e,()=>`<code class="language-cs"><span class="token comment">/// &lt;summary></span>
...
<span class="token punctuation">&#125;</span></code>`),u(s),i(4),l(t,n)}const S=Object.freeze(Object.defineProperty({__proto__:null,default:m,metadata:a},Symbol.toStringTag,{value:"Module"}));export{S as _};
