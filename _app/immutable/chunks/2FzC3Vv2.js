import"./Bzak7iHL.js";import"./BrF70vDP.js";import{i,j as n,n as p}from"./v0O3ks5t.js";const e={title:"Setup Angular project in Visual Studio",date:"2016-10-23",description:"angular2, setup, visual studio",categories:["others"],tags:["angular"],icon:"icon-angular",readingTime:"4 min read"},{title:h,date:c,description:d,categories:g,tags:f,icon:m,readingTime:y}=e;var a=i(`<h1>Setup Angular2 Project in Visual Studio</h1> <p>The steps for setting up a project with an ASP.NET 4.x project in Visual
...
see the changes.</p>`,1);function l(t){var o=a();p(74),n(t,o)}const S=Object.freeze(Object.defineProperty({__proto__:null,default:l,metadata:e},Symbol.toStringTag,{value:"Module"}));export{S as _};
