...
<span class="token comment">/* Output:
           ...
           no match here
*/</span>
</code>`),e(n);var t=s(n,4);t.textContent="The following code is a console application that uses regular expressions to validate the format of each string in an array. The validation requires that each string take the form of a telephone number in which three groups of digits are separated by dashes, the first two groups contain three digits, and the third group contains four digits. This is done by using the regular expression ^\\d3-\\d3-\\d4$.";var p=s(t,2),l=o(p);c(l,()=>`<code class="language-csharp">
...
<span class="token comment">/* Output:
     ...
     4007-555-0111 - invalid
      407-555-0111 - valid
        407-2-5555 - invalid
*/</span>
</code>`),e(p),d(i,a)}export{b as default,g as metadata};
