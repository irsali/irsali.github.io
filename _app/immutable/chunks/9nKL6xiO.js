import"./Bzak7iHL.js";import"./BrF70vDP.js";import{i as k,k as s,l as d,j as g,m as e,o as t,n as b}from"./v0O3ks5t.js";import{h as p}from"./IeDmrjg6.js";const h={title:"Aurelia Breeze Client Startup",date:"2017-10-06",description:"aurelia, breeze",categories:["others"],tags:["Aurelia"],icon:"icon-aurelia",readingTime:"1 min read"},{title:w,date:v,description:_,categories:S,tags:A,icon:B,readingTime:x}=h;var m=k(`<h1>Getting Started</h1> <h2>Pre Requisites</h2> <p>Aurelia Setup project</p> <h2>Dependencies</h2> <ul><li><p><a href="https://github.com/aurelia/binding" rel="nofollow">aurelia-binding</a></p></li> <li><p><a href="https://github.com/aurelia/dependency-injection" rel="nofollow">aurelia-dependency-injection</a></p></li> <li><p><a href="https://github.com/aurelia/fetch-client" rel="nofollow">aurelia-fetch-client</a></p></li> <li><p><a href="http://www.getbreezenow.com/breezejs" rel="nofollow">breeze</a></p></li></ul> <h2>Installs</h2> <pre class="language-node"><!></pre> <h2>Update aurelia.json for path of above installs</h2> <pre class="language-json"><!></pre> <h2>Register aurelia-breeze plugin with Aurelia</h2> <pre class="language-ts"><!></pre> <p>Bingo!!! You are ready to use breeze in your Aurelia application.</p> <h1>Error</h1> <p>If you will use breeze.debug.js. It contains all adapters and will give
...
below error.</p> <p>Provide breeze-client/modelLibrary.backingStore.js via import in main.ts</p> <p><img src="/static/blog/Aurelia/aurelia-breeze-client-startup/2.png"/></p> <p>Voila, Errors are gone.</p> <h1>References</h1> <ul><li><p><a href="http://breeze.github.io/doc-js/" rel="nofollow">http://breeze.github.io/doc-js/</a></p></li> <li><p><a href="https://github.com/jdanyow/aurelia-breeze" rel="nofollow">https://github.com/jdanyow/aurelia-breeze</a></p></li> <li><p><a href="https://github.com/Breeze/breeze.bridge.angular/issues/6" rel="nofollow">https://github.com/Breeze/breeze.bridge.angular/issues/6</a></p></li></ul>`,1);function R(l){var o=m(),a=s(d(o),12),i=e(a);p(i,()=>`<code class="language-node">npm install aurelia-fetch-client --save

npm install aurelia-breeze --save</code>`),t(a);var n=s(a,4),c=e(n);p(c,()=>`<code class="language-json"><span class="token punctuation">&#123;</span>
...
<span class="token punctuation">&#125;</span></code>`),t(n);var r=s(n,4),u=e(r);p(u,()=>`<code class="language-ts"><span class="token keyword">import</span> <span class="token string">'breeze-client/breeze.modelLibrary.backingStore'</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span></code>`),t(r),b(22),g(l,o)}export{R as default,h as metadata};
