import"./Bzak7iHL.js";import"./BrF70vDP.js";import{i,k as t,l as r,j as k,m as p,o as e}from"./v0O3ks5t.js";import{h as o}from"./IeDmrjg6.js";const m={title:"String manipulation in C#",date:"2016-09-24",description:"string manipulation",categories:["csharp"],tags:["csharp"],icon:"icon-csharp",readingTime:"3 min read"},{title:w,date:b,description:v,categories:x,tags:S,icon:T,readingTime:R}=m;var h=i(`<h2>Preface</h2> <p>Some code help to search, replace, remove string.</p> <p>Strings are <em>immutable</em> in managed code, it is not possible (without using unsafe code) to modify the value of a string object after it has been
...
called to create a new string.</p> <pre class="language-csharp"><!></pre>`,1);function _(c){var s=h(),n=t(r(s),10),u=p(n);o(u,()=>`<code class="language-csharp">
...
<span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span>
</code>`),e(n);var a=t(n,6),l=p(a);o(l,()=>`<code class="language-csharp">
...
*/</span>
</code>`),e(a),k(c,s)}export{_ as default,m as metadata};
